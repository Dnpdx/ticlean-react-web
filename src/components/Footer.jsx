      ...
      <div>
       <div className="relative mt-16 bg-sky-400">
        ...
        <div className="px-4 pt-12 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
          <div className="md:flex sm:grid md:justify-between sm:justify-center gap-16 mb-8">
            <div className="grid justify-center m-4">
             <img className='w-[200] h-[150]' src="/src/assets/Logo.png" alt='Logo TIClean & Business' />
            </div>
            <div className="grid">            
              <div>
                <p className="text-center font-bold tracking-wide text-blue-700">
                  Contacto
                </p>
                <ul className="mt-2">
          ...
          <div className="flex flex-col justify-between pt-5 pb-10 border-t border-gray-600 sm:flex-row">
            <p className="text-sm telime-100">
            Copyright ©2023 Ti Clean & Business. Todos los derechos reservados 
            </p>
            <div className="flex items-center mt-4 space-x-4 sm:mt-0">
              <a
                href="https://www.instagram.com/ti_negocios/"
                className="transition-colors duration-300 text-deep-purple-100 hover:text-blue-600"
              >
